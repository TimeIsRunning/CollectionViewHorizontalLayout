#
#  Be sure to run `pod spec lint SSLCollectionViewLayout.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "pulsent"
  # spec.authors            = { "pulsent" => "" }
  # spec.social_media_url   = "https://twitter.com/pulsent"
  ...
  spec.source_files  = 'CollectionViewHorizontalLayout','CollectionViewHorizontalLayout/**/*.{h,m}'
